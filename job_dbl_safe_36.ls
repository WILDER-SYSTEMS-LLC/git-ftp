...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     4.562 deg,	J2=    70.847 deg,	J3=   -29.831 deg,
	J4=    26.786 deg,	J5=    27.818 deg,	J6=    66.041 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2404.780  mm,	Y =  2862.290  mm,	Z =    35.466  mm,
	W =      .871 deg,	P =     4.507 deg,	R =    16.741 deg,
	E1= -1300.000  mm
};
/END
