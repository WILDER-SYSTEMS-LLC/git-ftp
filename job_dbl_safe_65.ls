...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    20.624 deg,	J2=    56.770 deg,	J3=   -38.091 deg,
	J4=    25.478 deg,	J5=    38.325 deg,	J6=    68.829 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1973.300  mm,	Y =  4668.900  mm,	Z =    56.822  mm,
	W =     1.363 deg,	P =     2.486 deg,	R =    36.110 deg,
	E1=  -300.000  mm
};
/END
