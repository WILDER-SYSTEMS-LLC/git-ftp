...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     2.901 deg,	J2=    60.575 deg,	J3=   -35.866 deg,
	J4=    51.293 deg,	J5=    44.987 deg,	J6=    48.837 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2208.200  mm,	Y =  2855.550  mm,	Z =    51.476  mm,
	W =     1.862 deg,	P =     3.218 deg,	R =    36.443 deg,
	E1= -1300.000  mm
};
/END
