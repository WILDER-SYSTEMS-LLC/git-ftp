...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     4.996 deg,	J2=    11.399 deg,	J3=   -58.632 deg,
	J4=    32.915 deg,	J5=    64.688 deg,	J6=    75.082 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1078.630  mm,	Y =  2848.490  mm,	Z =    71.939  mm,
	W =    -1.521 deg,	P =    -1.717 deg,	R =    34.432 deg,
	E1= -1300.000  mm
};
/END
