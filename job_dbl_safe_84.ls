...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=    21.747 deg,	J2=    45.211 deg,	J3=   -46.986 deg,
	J4=    19.395 deg,	J5=    46.878 deg,	J6=    76.051 deg,
	E1= -2000.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1785.980  mm,	Y =  6499.680  mm,	Z =    54.702  mm,
	W =      .850 deg,	P =     1.727 deg,	R =    35.780 deg,
	E1= -2000.000  mm
};
/END
