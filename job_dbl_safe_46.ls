...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     1.554 deg,	J2=    31.590 deg,	J3=   -51.434 deg,
	J4=    40.426 deg,	J5=    58.575 deg,	J6=    66.350 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1582.240  mm,	Y =  3768.530  mm,	Z =    72.145  mm,
	W =     -.195 deg,	P =      .155 deg,	R =    35.151 deg,
	E1=  -300.000  mm
};
/END
