...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     1.048 deg,	J2=    41.134 deg,	J3=   -46.733 deg,
	J4=    43.843 deg,	J5=    54.697 deg,	J6=    61.293 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1815.450  mm,	Y =  3755.150  mm,	Z =    68.952  mm,
	W =      .358 deg,	P =      .996 deg,	R =    35.477 deg,
	E1=  -300.000  mm
};
/END
