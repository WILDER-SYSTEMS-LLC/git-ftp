...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=    16.940 deg,	J2=    38.865 deg,	J3=   -50.881 deg,
	J4=    24.085 deg,	J5=    51.888 deg,	J6=    74.394 deg,
	E1=  -743.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1695.250  mm,	Y =  8216.070  mm,	Z =    47.329  mm,
	W =      .681 deg,	P =     1.470 deg,	R =    35.675 deg,
	E1=  -743.000  mm
};
/END
