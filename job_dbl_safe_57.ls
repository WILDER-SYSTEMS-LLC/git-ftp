...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    29.625 deg,	J2=    26.005 deg,	J3=   -54.372 deg,
	J4=     5.857 deg,	J5=    56.094 deg,	J6=    88.008 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1161.320  mm,	Y =  4669.960  mm,	Z =    67.807  mm,
	W =    -1.418 deg,	P =    -1.577 deg,	R =    34.485 deg,
	E1=  -300.000  mm
};
/END
