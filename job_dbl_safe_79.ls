...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=     7.820 deg,	J2=    10.787 deg,	J3=   -63.305 deg,
	J4=    28.268 deg,	J5=    68.925 deg,	J6=    79.942 deg,
	E1= -2000.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1046.340  mm,	Y =  6496.370  mm,	Z =    51.505  mm,
	W =    -2.241 deg,	P =    -2.748 deg,	R =    34.079 deg,
	E1= -2000.000  mm
};
/END
