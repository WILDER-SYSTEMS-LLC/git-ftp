...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    19.339 deg,	J2=    67.345 deg,	J3=   -31.980 deg,
	J4=    32.999 deg,	J5=    32.819 deg,	J6=    60.429 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2155.600  mm,	Y =  4672.320  mm,	Z =    42.441  mm,
	W =     2.004 deg,	P =     3.412 deg,	R =    36.539 deg,
	E1=  -300.000  mm
};
/END
