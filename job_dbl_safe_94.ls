...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=    17.742 deg,	J2=    43.516 deg,	J3=   -48.352 deg,
	J4=    24.576 deg,	J5=    48.785 deg,	J6=    72.768 deg,
	E1=  -743.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1792.560  mm,	Y =  8283.510  mm,	Z =    42.279  mm,
	W =     1.175 deg,	P =     2.163 deg,	R =    35.987 deg,
	E1=  -743.000  mm
};
/END
