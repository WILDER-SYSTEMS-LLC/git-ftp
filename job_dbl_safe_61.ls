...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    24.406 deg,	J2=    39.264 deg,	J3=   -47.800 deg,
	J4=    14.406 deg,	J5=    48.549 deg,	J6=    80.572 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1567.140  mm,	Y =  4669.860  mm,	Z =    70.684  mm,
	W =     -.192 deg,	P =      .159 deg,	R =    35.153 deg,
	E1=  -300.000  mm
};
/END
