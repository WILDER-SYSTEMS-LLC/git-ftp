...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     3.305 deg,	J2=    75.198 deg,	J3=   -26.671 deg,
	J4=    59.404 deg,	J5=    39.408 deg,	J6=    37.667 deg,
	E1= -2000.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2272.020  mm,	Y =  2187.720  mm,	Z =    53.265  mm,
	W =     1.935 deg,	P =     3.329 deg,	R =    36.493 deg,
	E1= -2000.000  mm
};
/END
