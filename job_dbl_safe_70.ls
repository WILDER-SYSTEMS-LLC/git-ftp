...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=   -26.875 deg,	J2=    13.864 deg,	J3=   -62.544 deg,
	J4=    62.419 deg,	J5=    79.764 deg,	J6=    68.278 deg,
	E1= -2000.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =   968.135  mm,	Y =  5584.460  mm,	Z =    54.143  mm,
	W =    -2.435 deg,	P =    -3.003 deg,	R =    33.987 deg,
	E1= -2000.000  mm
};
/END
