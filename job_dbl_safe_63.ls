...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    22.081 deg,	J2=    47.084 deg,	J3=   -43.603 deg,
	J4=    19.303 deg,	J5=    44.334 deg,	J6=    75.855 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1771.170  mm,	Y =  4654.220  mm,	Z =    67.086  mm,
	W =      .294 deg,	P =      .899 deg,	R =    35.439 deg,
	E1=  -300.000  mm
};
/END
