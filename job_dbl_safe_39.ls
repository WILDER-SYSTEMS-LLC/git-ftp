...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     1.959 deg,	J2=      .081 deg,	J3=   -61.038 deg,
	J4=    34.489 deg,	J5=    68.863 deg,	J6=    76.688 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =   826.301  mm,	Y =  3750.970  mm,	Z =    56.474  mm,
	W =    -2.628 deg,	P =    -3.254 deg,	R =    33.898 deg,
	E1=  -300.000  mm
};
/END
