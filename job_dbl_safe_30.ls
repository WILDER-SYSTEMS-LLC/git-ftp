...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     3.128 deg,	J2=    37.018 deg,	J3=   -48.754 deg,
	J4=    39.969 deg,	J5=    55.764 deg,	J6=    65.044 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1717.960  mm,	Y =  2834.760  mm,	Z =    74.059  mm,
	W =     -.101 deg,	P =      .303 deg,	R =    35.206 deg,
	E1= -1300.000  mm
};
/END
