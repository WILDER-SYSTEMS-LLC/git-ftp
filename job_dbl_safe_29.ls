...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     3.746 deg,	J2=    31.794 deg,	J3=   -51.215 deg,
	J4=    38.123 deg,	J5=    57.553 deg,	J6=    67.459 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1586.480  mm,	Y =  2850.400  mm,	Z =    75.042  mm,
	W =     -.208 deg,	P =      .135 deg,	R =    35.144 deg,
	E1= -1300.000  mm
};
/END
