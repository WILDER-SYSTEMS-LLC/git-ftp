...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     3.053 deg,	J2=    42.398 deg,	J3=   -45.950 deg,
	J4=    41.972 deg,	J5=    53.221 deg,	J6=    61.980 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1845.640  mm,	Y =  2839.600  mm,	Z =    72.005  mm,
	W =      .306 deg,	P =      .934 deg,	R =    35.446 deg,
	E1= -1300.000  mm
};
/END
