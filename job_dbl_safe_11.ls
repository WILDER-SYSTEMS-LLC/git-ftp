...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     1.879 deg,	J2=    65.339 deg,	J3=   -32.608 deg,
	J4=    54.393 deg,	J5=    43.892 deg,	J6=    45.158 deg,
	E1= -2000.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2149.230  mm,	Y =  2108.150  mm,	Z =    62.398  mm,
	W =     1.552 deg,	P =     2.770 deg,	R =    36.235 deg,
	E1= -2000.000  mm
};
/END
