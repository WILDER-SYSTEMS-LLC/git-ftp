...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     1.821 deg,	J2=     4.367 deg,	J3=   -60.401 deg,
	J4=    35.151 deg,	J5=    67.881 deg,	J6=    75.669 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =   918.051  mm,	Y =  3751.840  mm,	Z =    61.918  mm,
	W =    -2.209 deg,	P =    -2.679 deg,	R =    34.093 deg,
	E1=  -300.000  mm
};
/END
