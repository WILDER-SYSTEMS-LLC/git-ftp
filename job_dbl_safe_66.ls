...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    19.917 deg,	J2=    62.253 deg,	J3=   -34.941 deg,
	J4=    29.226 deg,	J5=    35.373 deg,	J6=    64.633 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2073.430  mm,	Y =  4671.910  mm,	Z =    49.531  mm,
	W =     1.739 deg,	P =     3.031 deg,	R =    36.359 deg,
	E1=  -300.000  mm
};
/END
