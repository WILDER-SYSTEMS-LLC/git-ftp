...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=      .973 deg,	J2=    46.102 deg,	J3=   -44.069 deg,
	J4=    46.287 deg,	J5=    52.253 deg,	J6=    57.728 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1925.860  mm,	Y =  3755.230  mm,	Z =    64.356  mm,
	W =      .965 deg,	P =     1.901 deg,	R =    35.853 deg,
	E1=  -300.000  mm
};
/END
