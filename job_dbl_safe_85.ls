...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=     4.596 deg,	J2=    44.716 deg,	J3=   -47.364 deg,
	J4=    41.408 deg,	J5=    52.349 deg,	J6=    61.829 deg,
	E1= -2000.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1929.370  mm,	Y =  6498.060  mm,	Z =    45.912  mm,
	W =     1.523 deg,	P =     2.703 deg,	R =    36.215 deg,
	E1= -2000.000  mm
};
/END
