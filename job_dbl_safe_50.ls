...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=      .974 deg,	J2=    51.427 deg,	J3=   -41.182 deg,
	J4=    48.825 deg,	J5=    49.885 deg,	J6=    54.015 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2036.880  mm,	Y =  3758.160  mm,	Z =    57.876  mm,
	W =     1.438 deg,	P =     2.598 deg,	R =    36.159 deg,
	E1=  -300.000  mm
};
/END
