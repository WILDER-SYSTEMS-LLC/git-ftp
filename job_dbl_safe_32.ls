...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     2.811 deg,	J2=    48.078 deg,	J3=   -42.847 deg,
	J4=    44.994 deg,	J5=    50.425 deg,	J6=    57.791 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1970.190  mm,	Y =  2837.170  mm,	Z =    67.164  mm,
	W =      .966 deg,	P =     1.926 deg,	R =    35.854 deg,
	E1= -1300.000  mm
};
/END
