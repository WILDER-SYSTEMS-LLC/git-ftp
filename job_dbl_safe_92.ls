...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=    15.772 deg,	J2=    34.036 deg,	J3=   -53.477 deg,
	J4=    24.020 deg,	J5=    55.304 deg,	J6=    75.876 deg,
	E1=  -743.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1590.540  mm,	Y =  8135.340  mm,	Z =    50.939  mm,
	W =      .104 deg,	P =      .602 deg,	R =    35.325 deg,
	E1=  -743.000  mm
};
/END
