...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     2.780 deg,	J2=    54.094 deg,	J3=   -39.510 deg,
	J4=    48.024 deg,	J5=    47.707 deg,	J6=    53.485 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2091.630  mm,	Y =  2842.990  mm,	Z =    60.484  mm,
	W =     1.473 deg,	P =     2.661 deg,	R =    36.182 deg,
	E1= -1300.000  mm
};
/END
