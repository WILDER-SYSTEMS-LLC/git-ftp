...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=     1.054 deg,	J2=    36.278 deg,	J3=   -49.250 deg,
	J4=    42.030 deg,	J5=    57.010 deg,	J6=    64.162 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1699.550  mm,	Y =  3752.350  mm,	Z =    70.880  mm,
	W =     -.077 deg,	P =      .333 deg,	R =    35.219 deg,
	E1=  -300.000  mm
};
/END
