...
P[1]{
   GP1:
	UF : 2, UT : 3,	
	J1=    41.485 deg,	J2=    21.723 deg,	J3=   -61.419 deg,
	J4=   -43.385 deg,	J5=    73.735 deg,	J6=   109.671 deg,
	E1= -2700.000  mm
};
P[2]{
   GP1:
	UF : 2, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =   941.904  mm,	Y =  6521.450  mm,	Z =    43.390  mm,
	W =     -.409 deg,	P =    -5.038 deg,	R =      .034 deg,
	E1= -2700.000  mm
};
/END
