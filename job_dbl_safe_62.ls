...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=    23.243 deg,	J2=    43.537 deg,	J3=   -45.588 deg,
	J4=    16.659 deg,	J5=    46.439 deg,	J6=    78.480 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  1679.020  mm,	Y =  4667.590  mm,	Z =    68.791  mm,
	W =     -.054 deg,	P =      .369 deg,	R =    35.233 deg,
	E1=  -300.000  mm
};
/END
