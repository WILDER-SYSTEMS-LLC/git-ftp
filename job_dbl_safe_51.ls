...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=      .960 deg,	J2=    56.849 deg,	J3=   -38.194 deg,
	J4=    51.524 deg,	J5=    47.696 deg,	J6=    50.161 deg,
	E1=  -300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =  2140.790  mm,	Y =  3760.050  mm,	Z =    50.013  mm,
	W =     1.800 deg,	P =     3.125 deg,	R =    36.401 deg,
	E1=  -300.000  mm
};
/END
