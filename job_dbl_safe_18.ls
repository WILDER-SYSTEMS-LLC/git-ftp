...
P[1]{
   GP1:
	UF : 1, UT : 3,	
	J1=   -28.864 deg,	J2=    12.818 deg,	J3=   -58.594 deg,
	J4=    65.441 deg,	J5=    78.391 deg,	J6=    63.633 deg,
	E1= -1300.000  mm
};
P[2]{
   GP1:
	UF : 1, UT : 4,		CONFIG : 'F U T, 0, 0, 0',
	X =   911.909  mm,	Y =  1912.970  mm,	Z =    70.155  mm,
	W =    -1.950 deg,	P =    -2.316 deg,	R =    34.218 deg,
	E1= -1300.000  mm
};
/END
